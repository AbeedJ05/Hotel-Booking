...
// Query to fetch reservations with hotel and room details
 $sql = "SELECT r.reservation_id, u.phone,r.total_price, r.check_in_date, r.check_out_date, h.hotel_name, rm.room_type, u.username
        FROM reservation r
        INNER JOIN rooms rm ON r.room_id = rm.id
        INNER JOIN hotels h ON rm.hotel_id = h.hotel_id
        INNER JOIN user u ON r.user_id = u.id ORDER BY r.reservation_id DESC" ;
        ;
